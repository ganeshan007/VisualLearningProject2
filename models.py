...
class CustomGAN_Generator(nn.Module):
    def __init__(self, ngf):
        super().__init__()
        self.conv1 = nn.Conv3d(3, ngf, (3,4,4), stride=(1,2,2), padding=1, bias=False)
        self.conv2 = nn.Conv3d(ngf, ngf*2, (4,4,4), stride=(2,2,2), padding=1, bias=False)
        self.conv3 = nn.Conv3d(ngf*2, ngf*4, (4,4,4), stride=(2,2,2), padding=1, bias=False)
        self.conv4 = nn.Conv3d(ngf*4, ngf*8, (4,4,4), stride=(2,2,2), padding=1, bias=False)
        self.conv5 = nn.Conv3d(ngf*8, ngf*16, (4,4,4), stride=(2,2,2), padding=1, bias=False)
        self.conv6 = nn.Conv3d(ngf*16, ngf*16, (4,4,4), stride=(2,2,2), padding=1, bias=False)
        ...
        self.up1 = nn.ConvTranspose3d(ngf*16, ngf*16, (2,4,4), stride=(1,1,1), padding=0, bias=False)
        ...
        self.up5 = nn.ConvTranspose3d(ngf*2, ngf, 4, 2, 1, bias=False)
        self.up6 = nn.ConvTranspose3d(ngf, 3, (3,4,4), (1,2,2), 1, bias=False)
